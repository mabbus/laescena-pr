...
?>
  <div id="isotope-container">
    ...
    <?php foreach ( $rows as $id => $row ): ?>
      ...
      $tmp_row = $count/2;
      if ($tmp_row%2 == 1) {
        $right_img_class = 'right-image-order';
      }

      ?>
      <div class="isotope-element isotope-element-<?php print $count; ?> <?php print $classlist; ?> <?php print $right_img_class; ?>" data-category="<?php print $classlist; ?>" <?php print $bgstyle ?>>
        <?php print $row; ?>
      </div>
      <?php 
      // reset
